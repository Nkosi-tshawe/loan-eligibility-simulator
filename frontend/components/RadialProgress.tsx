    ...
    return (
        <div className="relative size-40">
            <svg className="size-full" height="36" viewBox="0 0 36 36" width="36" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle className={`stroke-current ${progressColorClass}`} cx="18" cy="18" fill="none" r="16" stroke-dasharray="100" stroke-dashoffset={`${100 - value}`} stroke-linecap="round" stroke-width="3" transform="rotate(-90 18 18)"></circle>
            </svg>
